...
detect_unet_bp = Blueprint('detect_unet', __name__,url_prefix='/local')


@detect_unet_bp.post('/img/detect_unet')
def detect():
    ...
    if mode == "video":
        ...
        r_image,classes = centernet.detect_image(image=img, count=count)
        new_classes = {}
