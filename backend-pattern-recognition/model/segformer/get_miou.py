...
if __name__ == "__main__":
    ...
    name_classes = ["_background_", "Headwear", "hat", "top", "belt", "pants", "skirt", "boots", "necklace"]
    #-------------------------------------------------------#
    #   指向VOC数据集所在的文件夹
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    ...
    image_ids       = open(os.path.join(VOCdevkit_path, "val.txt"),'r',encoding='utf-8').read().splitlines()
