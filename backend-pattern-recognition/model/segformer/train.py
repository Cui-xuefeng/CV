...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = r"F:\桌面\segformer-pytorch-master\model_data\segformer_b2_weights_voc.pth"
    #------------------------------#
    #   输入图片的大小
    #------------------------------#
    input_shape     = [512, 512]
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "train.txt"),"r",encoding='utf-8') as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "val.txt"),"r",encoding='utf-8') as f:
