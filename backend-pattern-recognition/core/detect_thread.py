...
# from app import current_frame, is_detecting, capture, frame_lock, detect_lock, capture_lock
...
from model.segformer.singleton import SegFormer




def detect_camera(video_path=0, save_video=False):
    video_writer = None
    video_save_path = ""
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                detect_output = SegFormer.detect_image(frame_img)
